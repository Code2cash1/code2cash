...
export const StardustButton: React.FC<StardustButtonProps> = ({
  ...
  const buttonStyle: React.CSSProperties = {
    ...
    boxShadow: `
      inset 0 0.3rem 0.9rem rgba(49, 163, 156, 0.3),
      inset 0 -0.1rem 0.3rem rgba(0, 0, 0, 0.7),
      inset 0 -0.4rem 0.9rem rgba(49, 163, 156, 0.5),
  ...
  const pStyle: React.CSSProperties = {
    ...
    maskImage: 'linear-gradient(to bottom, rgba(49, 163, 156, 1) 40%, transparent)',
  };
  ...
  const beforeAfterStyles = `
    ...
    .pearl-button .wrap::before {
      ...
      top: -100%;
      border-radius: 50%;
      background-color: rgba(49, 163, 156, 0.15);
    }
    ...
    .pearl-button .wrap::after {
      ...
      box-shadow: inset 0 10px 8px -10px rgba(49, 163, 156, 0.6);
      background: linear-gradient(
        180deg,
        rgba(49, 163, 156, 0.25) 0%,
        rgba(0, 0, 0, 0) 50%,
        rgba(0, 0, 0, 0) 100%
      );
    }
    ...
    .pearl-button:hover {
      box-shadow:
        inset 0 0.3rem 0.5rem rgba(49, 163, 156, 0.4),
        inset 0 -0.1rem 0.3rem rgba(0, 0, 0, 0.7),
        inset 0 -0.4rem 0.9rem rgba(49, 163, 156, 0.6),
        0 3rem 3rem rgba(0, 0, 0, 0.3),
        0 1rem 1rem -0.6rem rgba(0, 0, 0, 0.8);
    }
    ...
    .pearl-button:active {
      ...
      box-shadow:
        inset 0 0.3rem 0.5rem rgba(49, 163, 156, 0.5),
        inset 0 -0.1rem 0.3rem rgba(0, 0, 0, 0.8),
        inset 0 -0.4rem 0.9rem rgba(49, 163, 156, 0.4),
        0 3rem 3rem rgba(0, 0, 0, 0.3),
        0 1rem 1rem -0.6rem rgba(0, 0, 0, 0.8);
    }
  `;
