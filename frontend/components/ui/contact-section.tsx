                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                            ...
                            <div className="pt-2">
                                <Button
                                    ...
                                    className="w-full bg-[#31a39c] hover:bg-[#2a8a84] text-white font-medium py-6 text-lg shadow-lg shadow-[#31a39c]/20 hover:shadow-[#31a39c]/40 transition-all duration-300 rounded-lg"
                                >
