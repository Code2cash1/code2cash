...
export default function AdminInternshipsPage() {
    ...
    // Form State for New/Edit Internship
    ...
    const handleCreateProgram = async () => {
        ...
        try {
            ...
            if (res.ok) {
                alert(editingProgramId ? "Program Updated Successfully!" : "Internship Program Published Successfully!");
                setProgramForm({
                    title: "", department: "", duration: "", price: "", description: "", highlights: "", projects: "", imageUrl: ""
                });
                setImageFile(null);
                    ...
                    <div className="max-w-7xl mx-auto space-y-8">
                        ...
                        <div className="bg-[#0a0a0a] border border-white/10 p-1 rounded-md inline-flex space-x-1 flex-wrap gap-1">
                            <button
                                ...
                                className={`px-4 py-2 text-sm font-medium rounded-sm transition-all ${activeTab === "applications"
                                    ? "bg-[#31a39c] text-white shadow-sm"
                            ...
                            <button
                                ...
                                className={`px-4 py-2 text-sm font-medium rounded-sm transition-all ${activeTab === "manage"
                                    ? "bg-[#31a39c] text-white shadow-sm"
                                    : "text-white/60 hover:text-white hover:bg-white/5"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-4 py-2 text-sm font-medium rounded-sm transition-all ${activeTab === "add-new"
                                    ? "bg-[#31a39c] text-white shadow-sm"
                                    : "text-white/60 hover:text-white hover:bg-white/5"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-4 py-2 text-sm font-medium rounded-sm transition-all ${activeTab === "certificates"
                                    ? "bg-[#31a39c] text-white shadow-sm"
                                    : "text-white/60 hover:text-white hover:bg-white/5"
                                    }`}
                            >
                            ...
                            <div className="space-y-4 animate-in fade-in zoom-in-95 duration-200">
                                <div className="flex items-center gap-4 bg-[#0a0a0a] p-4 rounded-lg border border-white/10">
                                    ...
                                    <Input
                                        ...
                                        className="bg-transparent border-none text-white placeholder:text-white/30 p-0 focus-visible:ring-0"
                                        value={searchQuery}
                                                    ...
                                                    <div key={app._id} className="flex flex-col md:flex-row gap-4 p-4 hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                                                        <div className="flex items-start gap-4 flex-1">
                                                            ...
                                                            <div className="space-y-1 flex-1">
                                                                <div className="flex flex-wrap items-center gap-2">
                                                                    ...
                                                                    <Badge variant="outline" className="text-[10px] border-[#31a39c]/30 text-[#31a39c] bg-[#31a39c]/5">
                                                                        {app.program}
                                                                    </Badge>
                                                        ...
                                                        <div className="flex items-center justify-end gap-2 pl-14 md:pl-0">
                                                            ...
                                                            <Button
                                                                variant="outline"
                                                                size="sm"
                                                                className="h-8 border-white/10 hover:bg-[#31a39c] hover:text-white hover:border-[#31a39c] transition-colors"
                                        ...
                                        <Card key={program._id} className="bg-[#0a0a0a] border-white/10 hover:border-[#31a39c]/50 transition-colors">
                                            <CardHeader>
                                                <div className="flex items-start justify-between">
                                                    ...
                                                    <Badge variant={program.active ? "default" : "secondary"} className="bg-[#31a39c]/20 text-[#31a39c]">
                                ...
                                {programs.length === 0 && (
                                    <div className="text-center py-12 text-white/40">
                                        ...
                                        <Button
                                            ...
                                            className="mt-4 bg-[#31a39c] hover:bg-[#288a84]"
                                        >
                            ...
                            <Card className="bg-[#0a0a0a] border-white/10 animate-in fade-in zoom-in-95 duration-200">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-white/60">
                                        {editingProgramId ? "Update the details of the internship program." : "Fill in the details to create a new internship opportunity."}
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder="e.g. Frontend React Developer Internship"
                                            className="bg-[#030303] border-white/10 text-white"
                                        />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <Select onValueChange={(val) => setProgramForm({ ...programForm, department: val })}>
                                                <SelectTrigger className="bg-[#030303] border-white/10 text-white">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="space-y-2">
                                                <Input
                                                    ...
                                                    className="bg-[#030303] border-white/10 text-white file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-[#31a39c] file:text-white hover:file:bg-[#288a84]"
                                                />
                                                ...
                                                />
                                                {imageFile && (
                                                    <p className="text-xs text-green-400">✓ File selected: {imageFile.name}</p>
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea
                                            ...
                                            className="bg-[#030303] border-white/10 text-white min-h-[100px]"
                                        />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <Textarea
                                                ...
                                                placeholder="React.js Fundamentals&#10;State Management&#10;API Integration"
                                                className="bg-[#030303] border-white/10 text-white min-h-[120px]"
                                            />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Textarea
                                                value={programForm.projects}
                                                onChange={(e) => setProgramForm({ ...programForm, projects: e.target.value })}
                                    ...
                                    <Button
                                        ...
                                        className="bg-[#31a39c] hover:bg-[#288a84] text-white w-full md:w-auto"
                                    >
                                        {isSubmitting ? (
                                            <><Loader2 className="mr-2 h-4 w-4 animate-spin" /> {editingProgramId ? "Updating..." : "Publishing..."}</>
                                        ) : (
                                            <><Plus className="mr-2 h-4 w-4" /> {editingProgramId ? "Update Program" : "Publish Program"}</>
                                        )}
                                    </Button>
                                </CardContent>
                            </Card>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-white font-medium flex items-center gap-2">
                                            <Phone className="h-4 w-4 text-[#31a39c]" />
                                            {selectedApp.phone}
                                        </p>
                                    </div>
                                    <div className="space-y-1">
                                        <Label className="text-white/60 text-xs">Applied For</Label>
                                        <Badge className="bg-[#31a39c]/20 text-[#31a39c] border-[#31a39c]/30">
                                            {selectedApp.program}
                                        </Badge>
                                    </div>
                                </div>
