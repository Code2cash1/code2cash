...
import { Search, CheckCircle2, XCircle, Shield, Download, Share2, Calendar, User, Building2, FileCheck, Sparkles, Trophy, ArrowLeft, Loader2, RefreshCw } from 'lucide-react';
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/api/reissue`, {
                ...
                body: JSON.stringify({
                    ...
                    internName: certificateData.internName,
                    email: certificateData.email || 'user@example.com',
                                        ...
                                        >
                                            {verificationResult === 'valid' && certificateData ? (
                                                <div className="space-y-6">
                                                        ...
                                                        <div className="p-6 bg-white/5 rounded-2xl border border-white/10 hover:bg-white/10 transition-all group/card">
                                                            <div className="flex items-start gap-4">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-white font-semibold text-lg">{certificateData.internName}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="p-6 bg-white/5 rounded-2xl border border-white/10 hover:bg-white/10 transition-all group/card">
                                                            <div className="flex items-start gap-4">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-white font-semibold text-lg max-w-[200px] truncate" title={certificateData.domain}>{certificateData.domain}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="p-6 bg-white/5 rounded-2xl border border-white/10 hover:bg-white/10 transition-all group/card">
                                                            <div className="flex items-start gap-4">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-white font-semibold text-lg">{new Date(certificateData.issueDate).toLocaleDateString()}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="p-6 bg-gradient-to-br from-[#31a39c]/10 to-transparent rounded-2xl border border-[#31a39c]/20">
                                                        ...
                                                        <div className="grid md:grid-cols-2 gap-4 text-sm">
                                                            <div>
                                                                ...
                                                                <span className="text-white font-mono ml-2">{certificateData.certificateId}</span>
                                                            </div>
                                                            <div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <span className="text-white ml-2">{certificateData.duration} Internship</span>
                                                            </div>
                                                            <div>
                                                    ...
                                                    {/* Action Buttons - Replaced Download with Reissue */}
                                                    <div className="flex flex-col sm:flex-row gap-4">
                                                        <button
                                                            onClick={handleReissueRequest}
                                                            disabled={isRequesting}
                                                            className="flex-1 flex items-center justify-center gap-3 px-6 py-4 bg-[#31a39c] hover:bg-[#2a8a84] text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[#31a39c]/30 hover:scale-105 active:scale-95 disabled:opacity-50"
                                                        >
                                                            {isRequesting ? <Loader2 className="w-5 h-5 animate-spin" /> : <RefreshCw className="w-5 h-5" />}
                                                            {isRequesting ? 'Submitting...' : 'Request Certificate Reissue'}
                                                        </button>
                                                        <button
                                                            onClick={handleShare}
                                                    ...
                                                    <div className="flex items-start gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-white/80 mb-4">
                                                                We couldn&apos;t find a certificate matching this ID in our database.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
