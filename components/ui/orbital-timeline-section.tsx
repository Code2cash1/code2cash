...
const defaultCards = [
  {
    ...
    className:
      "[grid-area:stack] transition-all duration-500 ease-out hover:-translate-y-10 hover:scale-105 before:absolute before:w-[100%] before:outline-1 before:rounded-xl before:outline-border before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-background/50 grayscale-[100%] hover:before:opacity-0 before:transition-all before:duration-500 hover:grayscale-0 before:left-0 before:top-0",
  },
  {
    ...
    titleClassName: "text-teal-500",
    className:
      "[grid-area:stack] translate-x-12 translate-y-10 transition-all duration-500 ease-out hover:-translate-y-1 hover:scale-105 before:absolute before:w-[100%] before:outline-1 before:rounded-xl before:outline-border before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-background/50 grayscale-[100%] hover:before:opacity-0 before:transition-all before:duration-500 hover:grayscale-0 before:left-0 before:top-0",
  },
  {
    ...
    titleClassName: "text-teal-500",
    className:
      "[grid-area:stack] translate-x-24 translate-y-20 transition-all duration-500 ease-out hover:translate-y-10 hover:scale-105 grayscale-[80%] hover:grayscale-0",
  },
];
