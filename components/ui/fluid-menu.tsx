    ...
    return (
        <div className="relative w-[64px]" data-expanded={isExpanded}>
            ...
            <div className="relative">
                ...
                <div
                    className="relative w-16 h-16 bg-black/80 backdrop-blur-md border border-white/10 shadow-lg shadow-teal-500/10 cursor-pointer rounded-full group will-change-transform z-50 transition-colors duration-300 hover:bg-black/90"
                ...
                {childrenArray.slice(1).map((child, index) => (
                    <div
                        key={index}
                        className="absolute top-0 left-0 w-16 h-16 bg-black/80 backdrop-blur-md border border-white/10 shadow-lg cursor-pointer will-change-transform"
                        style={{
