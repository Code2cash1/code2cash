...
export default function RadialOrbitalTimeline({
  ...
  useEffect(() => {
    // Remove JavaScript rotation - use CSS animation instead
  }, [autoRotate, viewMode]);
  ...
  return (
    <div
      className="w-full h-screen flex flex-col items-center justify-center bg-[#030303] overflow-hidden"
      ref={containerRef}
      onClick={handleContainerClick}
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        <div
          className="absolute w-full h-full flex items-center justify-center orbital-container"
          ref={orbitRef}
          style={{
            perspective: "1000px",
